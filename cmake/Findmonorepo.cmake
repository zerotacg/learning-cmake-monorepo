if (CMAKE_VERSION VERSION_LESS 3.16.0)
    message(FATAL_ERROR "monorepo requires at least CMake version 3.16.0")
endif()


if (NOT monorepo_FIND_COMPONENTS)
    set(monorepo_NOT_FOUND_MESSAGE "The monorepo package requires at least one component")
...
foreach(module ${monorepo_FIND_COMPONENTS})
    ...
    if (NOT monorepo-${module}_FOUND)
        ...
        if (monorepo_FIND_REQUIRED_${module})
            set(_monorepo_NOTFOUND_MESSAGE "${_monorepo_NOTFOUND_MESSAGE}Failed to find monorepo component \"${module}\" config file at \"${_expected_module_location}\"\n")
        elseif(NOT monorepo_FIND_QUIETLY)
            message(WARNING "Failed to find monorepo component \"${module}\" config file at \"${_expected_module_location}\"")
        endif()
